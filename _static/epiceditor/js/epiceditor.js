...
(function (window, undefined) {
  ...
  EpicEditor.prototype.load = function (callback) {
    ...
    _HtmlTemplates = {
      ...
      chrome:   '<div id="epiceditor-wrapper" class="epiceditor-edit-mode">' +
                  ...
                  '<div id="epiceditor-utilbar">' +
                    '<img width="30" src="' + this.settings.basePath + this.settings.userButton.icon + '" title="Save" class="epiceditor-user-btn" ' + (this.settings.userButton.visible? '' : 'style="display: none"') + '> ' +
                    ...
                    '<img width="30" src="' + this.settings.basePath + '/images/side.png" title="Enter Fullscreen" class="epiceditor-fullscreen-btn">' +
                  '</div>' +
                '</div>'
    ...
    utilBtns.addEventListener('click', function (e) {
      ...
      if (targetClass.indexOf('epiceditor-user-btn') > -1) {
        (function() {
            self.settings.userButton.callback.apply(self, arguments);
        })()
      }
      else if (targetClass.indexOf('epiceditor-toggle-preview-btn') > -1) {
        self.preview();
      }
